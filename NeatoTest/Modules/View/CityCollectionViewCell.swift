...
class CityCollectionViewCell: UICollectionViewCell {
    ...
    func fillData (_ city: City) {
        ...
        self.cityImage.sd_setImage(with: URL(string: "https://images.app.goo.gl/AdXXAUfem1iPzB1x7"), placeholderImage: UIImage(named: "g1"), options: .progressiveLoad, completed: {
